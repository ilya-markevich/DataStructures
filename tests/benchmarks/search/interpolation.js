...
function searchIn10(createTest, searchData) {
  return createTest({
    name: 'Interpolation search in 10 elements',
    data: searchData.interpolationData,
...
function searchIn100(createTest, searchData) {
  return createTest({
    name: 'Interpolation search in 100 elements',
    data: searchData.interpolationData,
    setup: searchData.setup,
...
function searchIn1000(createTest, searchData) {
  return createTest({
    name: 'Interpolation search in 1000 elements',
    data: searchData.interpolationData,
    setup: searchData.setup,
...
function searchIn10000(createTest, searchData) {
  return createTest({
    name: 'Interpolation search in 10000 elements',
    data: searchData.interpolationData,
    setup: searchData.setup,
...
function searchIn100000(createTest, searchData) {
  return createTest({
    name: 'Interpolation search in 100000 elements',
    data: searchData.interpolationData,
    setup: searchData.setup,
...
function searchIn1000000(createTest, searchData) {
  return createTest({
    name: 'Interpolation search in 1000000 elements',
    data: searchData.interpolationData,
    setup: searchData.setup,
