...
function searchIn10(createTest, searchData) {
  return createTest({
    name: 'Binary search in 10 elements',
    data: searchData.binaryData,
...
function searchIn100(createTest, searchData) {
  return createTest({
    name: 'Binary search in 100 elements',
    data: searchData.binaryData,
    setup: searchData.setup,
...
function searchIn1000(createTest, searchData) {
  return createTest({
    name: 'Binary search in 1000 elements',
    data: searchData.binaryData,
    setup: searchData.setup,
...
function searchIn10000(createTest, searchData) {
  return createTest({
    name: 'Binary search in 10000 elements',
    data: searchData.binaryData,
    setup: searchData.setup,
...
function searchIn100000(createTest, searchData) {
  return createTest({
    name: 'Binary search in 100000 elements',
    data: searchData.binaryData,
    setup: searchData.setup,
...
function searchIn1000000(createTest, searchData) {
  return createTest({
    name: 'Binary search in 1000000 elements',
    data: searchData.binaryData,
    setup: searchData.setup,
