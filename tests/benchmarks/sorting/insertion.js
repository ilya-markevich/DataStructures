...
function sort10(createTest, sortingData) {
  return createTest({
    name: 'Insertion sort 10 elements',
    data: sortingData.dataInsertion,
...
function sort100(createTest, sortingData) {
  return createTest({
    name: 'Insertion sort 100 elements',
    data: sortingData.dataInsertion,
    setup: sortingData.setup,
...
function sort1000(createTest, sortingData) {
  return createTest({
    name: 'Insertion sort 1000 elements',
    data: sortingData.dataInsertion,
    setup: sortingData.setup,
...
function sort10000(createTest, sortingData) {
  return createTest({
    name: 'Insertion sort 10000 elements',
    data: sortingData.dataInsertion,
    setup: sortingData.setup,
