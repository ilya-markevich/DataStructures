...
function sort10(createTest, sortingData) {
  return createTest({
    name: 'Heap sort 10 elements',
    data: sortingData.dataHeap,
...
function sort100000(createTest, sortingData) {
  return createTest({
    name: 'Heap sort 100000 elements',
    data: sortingData.dataHeap,
    setup: sortingData.setup,
...
function sort1000000(createTest, sortingData) {
  return createTest({
    name: 'Heap sort 1000000 elements',
    data: sortingData.dataHeap,
    setup: sortingData.setup,
