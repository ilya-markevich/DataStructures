...
function sort10(createTest, sortingData) {
  return createTest({
    name: 'Selection sort 10 elements',
    data: sortingData.dataSelection,
...
function sort100(createTest, sortingData) {
  return createTest({
    name: 'Selection sort 100 elements',
    data: sortingData.dataSelection,
    setup: sortingData.setup,
...
function sort1000(createTest, sortingData) {
  return createTest({
    name: 'Selection sort 1000 elements',
    data: sortingData.dataSelection,
    setup: sortingData.setup,
...
function sort10000(createTest, sortingData) {
  return createTest({
    name: 'Selection sort 10000 elements',
    data: sortingData.dataSelection,
    setup: sortingData.setup,
