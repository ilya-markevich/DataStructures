...
function addToTop(createTest, listData) {
  return createTest({
    name: 'Singly Linked List #addToTop',
    data: {
      LinkedList: listData.data.SinglyLinkedList
    },
    setup: listData.setup,
...
function addBefore(createTest, listData) {
  return createTest({
    name: 'Singly Linked List #addBefore',
    data: {
      LinkedList: listData.data.SinglyLinkedList
    },
...
function addAfter(createTest, listData) {
  return createTest({
    name: 'Singly Linked List #addAfter',
    data: {
      LinkedList: listData.data.SinglyLinkedList
    },
    setup: listData.setupAddBeforeAndAfter,
...
function toArray(createTest, listData) {
  return createTest({
    name: 'Singly Linked List #toArray',
    data: {
      LinkedList: listData.data.SinglyLinkedList
    },
    setup: listData.setupAddBeforeAndAfter,
...
function copyTo(createTest, listData) {
  return createTest({
    name: 'Singly Linked List #copyTo',
    data: {
      LinkedList: listData.data.SinglyLinkedList
    },
...
function update(createTest, listData) {
  return createTest({
    name: 'Singly Linked List #update',
    data: {
      LinkedList: listData.data.SinglyLinkedList
    },
    setup: listData.setupWithArray,
...
function contains(createTest, listData) {
  return createTest({
    name: 'Singly Linked List #contains',
    data: {
      LinkedList: listData.data.SinglyLinkedList
    },
    setup: listData.setupWithArray,
...
function remove(createTest, listData) {
  return createTest({
    name: 'Singly Linked List #remove',
    data: {
      LinkedList: listData.data.SinglyLinkedList
    },
    setup: listData.setupWithArray,
